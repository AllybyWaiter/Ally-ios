...
const steps = [
  {
    ...
    details: [
      "Compatible with API, Tetra, Seachem test kits",
  ...
  },
  {
    ...
    details: [
      "Instant parameter detection",
      "Cross-reference with ideal ranges",
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Discover how AI-powered water testing makes aquarium maintenance simple, 
              accurate, and effortless for everyone—from beginners to experts.
            </p>
          </div>
        </div>
      </section>
