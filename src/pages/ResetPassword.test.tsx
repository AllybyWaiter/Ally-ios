...
describe('ResetPassword', () => {
  ...
  describe('Loading State', () => {
    it('shows loading indicator while checking session', () => {
      ...
      // Loading state renders a spinning emoji, no role="status"
  ...
  describe('Invalid Session', () => {
    ...
    it('has a link to auth page when session is invalid', async () => {
      mockGetSession.mockResolvedValue({ data: { session: null } });
      renderResetPassword();
      ...
      // The "Back to Sign In" button is wrapped in a Link to="/auth"
